...
set output "Zc_abs_T_S.eps"

#set style line 1 lt 1 lc 3 lw 2 pt 7 ps 0.5
#set style line 2 lt 1 lc 2 lw 2 pt 7 ps 0.8

set datafile separator ","
plot "./Zc_Schelkunoff.csv" u 1:(sqrt($2**2+$3**2)) w lp ls 1 lc "#E6001A" title "Absolute value of Z_c from Schelkunoff model", "./Zc_Tesche_MHz.csv" u 1:(sqrt($2**2+$3**2)) w lines ls 1 lc 2 title "Absolute value of Z_c from Tesche model"