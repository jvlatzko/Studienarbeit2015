...
S12_l   = load('$PATH');
S22_l   = load('$PATH');
S11c    = S11_l(1:end,2) + I*S11_l(1:end,3);  
S21c    = S21_l(1:end,2) + I*S21_l(1:end,3); 
S12c    = S12_l(1:end,2) + I*S12_l(1:end,3);  
S22c    = S22_l(1:end,2) + I*S22_l(1:end,3); 
Z01c    = S11_l(1:end,4) + I*S11_l(1:end,5); 
Z02c    = S22_l(1:end,4) + I*S22_l(1:end,5); 
F_l     = S11_l(1:end,1);  
