...
set output "G_Re_CST_T_final.eps"

#set style line 1 lt 1 lc 3 lw 2 pt 7 ps 0.5
#set style line 2 lt 1 lc 2 lw 2 pt 7 ps 0.8

set datafile separator ","
plot "./Gamma_CST_MHz.csv" u 1:2 w lines ls 1 lc "#E6001A" title "Attenuation constant {/Symbol a} from CST", "./Gamma_Tesche_MHz.csv" u 1:2 w lines ls 1 lc 2 title "Attenuation constant {/Symbol a} from Tesche model"