...
set output "Zc_Im_CST_T_final.eps"

#set style line 1 lt 1 lc 3 lw 2 pt 7 ps 0.5
#set style line 2 lt 1 lc 2 lw 2 pt 7 ps 0.8

set datafile separator ","
plot "./Zc_Tesche_MHz.csv" u 1:3 w lines ls 1 lc 2 title "Imaginary part of Z_c from Tesche model", "./Zc_CST_MHz.csv" u 1:3 w lines ls 1 lc "#E6001A" title "Imaginary part of Z_c from CST"